...
| Budget | Fold-0 pilots report measured seconds/step, wall time, and cost; one of the three `ARCHITECTURE.md §9` matrix options is selected and recorded |
